...
interface DemoModeBannerProps {
  className?: string;
  dismissible?: boolean;
  /** Position of the banner (for backwards compatibility, ignored) */
  position?: "top" | "bottom";
}
        ...
        <div className="flex flex-wrap items-center justify-between gap-2">
          <div className="flex items-center gap-3">
            ...
            <span className="text-sm text-amber-800 dark:text-amber-200">
              You&apos;re using a demo version of Legal Chatbot Builder. Please avoid uploading sensitive or confidential data.
            </span>
          </div>
